...
<template>
  <div class="page-shell">
    <header class="page-header"><div><h1 class="page-title">角色权限</h1><p class="page-subtitle">统一配置页面与 API 权限，数据范围由角色和项目关系共同约束。</p></div><el-button v-if="userStore.hasPermission('role:edit')" type="primary" :disabled="!selectedRole" @click="save">保存权限</el-button></header>
