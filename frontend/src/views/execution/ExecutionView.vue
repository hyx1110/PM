...
import { createExecution, getExecutions, updateExecution } from '@/api/execution'
...
const emptyForm=():ExecutionPayload=>({task_id:0,user_id:userStore.profile?.id,actual_start:dayjs().format('YYYY-MM-DD HH:mm:ss'),actual_end:undefined,actual_hours:0,status:'running',description:'',exception_reason:''})
