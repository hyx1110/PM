...
export const getUserOptions = (activeOnly = true) =>
  api.get<UserOption[]>('/lookups/users', { params: { active_only: activeOnly } })
export const getL3UserOptions = () => api.get<UserOption[]>('/lookups/l3-users')
export const getScheduleUserOptions = (params: { project_id?: number; keyword?: string; department_id?: number; organization_id?: number; organization_keyword?: string } = {}) =>
