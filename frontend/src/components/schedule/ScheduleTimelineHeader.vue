...
<style scoped>
.timeline-header{background:#fafbfc}.day-row{display:grid}.day-cell{display:flex;height:43px;align-items:center;justify-content:center;gap:7px;border-right:1px solid #e4e8ed;border-bottom:1px solid #e8ebef;color:#4a586c;font-size:12px}.day-cell span{color:#9aa3b1;font-size:10px}.day-cell em{border-radius:8px;background:#f9dede;padding:2px 6px;color:#a84f4f;font-size:8px;font-style:normal}.day-cell.day-holiday{background:#fff4f4}.day-cell.day-weekend{background:#f2f4f6;color:#8c96a3}.day-cell .workday-note{background:#e4f2ea;color:#43805f}.axis-row{display:flex;height:42px;border-bottom:1px solid #e8ebef}.time-axis{position:relative;flex:0 0 auto;border-right:1px solid #dfe4e9}.interval-band{position:absolute;inset-block:0}.interval-off-hours{background:#e9edf1}.interval-holiday{background:#fde8e8}.time-tick{position:absolute;top:0;height:100%;transform:translateX(-50%);color:#7e8998;font-size:9px;white-space:nowrap}.time-tick i{position:absolute;top:20px;left:50%;width:1px;height:22px;background:#d8dee5}.time-tick b{display:block;font-weight:500}.time-tick.first{transform:none}.time-tick.first i{left:0}.time-tick.last{transform:translateX(-100%)}.time-tick.last i{right:0;left:auto}
</style>
